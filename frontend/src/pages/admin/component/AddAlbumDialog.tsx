...
const AddAlbumDialog = () => {
    ...
    const handleSubmit = async () => {
        ...
        toast.success("Album craeted successfully");
        } catch (error: any) {
  ...
  return (
    <Dialog open={albumDialogOpen} onOpenChange = {setAlbumDialogOpen}>
        ...
        <DialogContent className="bg-zinc-900 border-l-zinc-700">
            <DialogHeader>
            ...
            <div className="space-y-4 py-4">
                ...
                <div
                className="flex items-center justify-center p-6 border-2 border-dashed border-zinc-700 rounded-lg
                cursor-pointer"
